...
- **Licensing**:
  - Parts of the codec are covered by [patent claims](https://www.sisvel.com/licensing-programs/audio-and-video-coding-decoding/video-coding-platform/license-terms/vp9-license-terms). Google [does not support these claims](https://www.webmproject.org/about/faq/).
  - According to Google, anyone may [use the codec freely](https://www.webmproject.org/license/bitstream/) as long as they do not engage in patent litigation.
- **Performance**:
...
- **Licensing**:
  - Parts of the codec are covered by [patent claims](https://www.sisvel.com/licensing-programs/audio-and-video-coding-decoding/video-coding-platform/license-terms/av1-license-terms). Google [does not support these claims](https://www.webmproject.org/about/faq/).
  - According to Google, anyone may [use the codec freely](https://www.webmproject.org/license/bitstream/) as long as they do not engage in patent litigation.
- **Performance**:
